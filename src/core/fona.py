...
Attributes:
    ...
    logger (logging.logger): logging object to display diagnostic information
"""
...
def _send_command(data):
    ...
    for the FONA to successfully read from.
...
def _get_output():
    ...
    logger.info('Flushing serial port contents: %s' % output)
    return output
